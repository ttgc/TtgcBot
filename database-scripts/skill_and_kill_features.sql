...
('Idole','-30% pour passer inapercu dans une foule / +30% pour les autres en test de connaissance sur elle (incompatible identite secrete)','Magical Girl','mgirl'),
('Seductrice','+15% en seduction et charme naturel','Magical Girl','mgirl'),
('Identite secrete','+30% pour passer inapercu dans une foule / -30% pour les autres en test de connaissance sur elle (incompatible idole)','Magical Girl','mgirl'),
