# TtgcBot
TtgcBot is a bot for Discord using discord.py lib and made in Python 3. The bot is made for RP (JDR) on The Tale of Great Cosmos
but have a lot of useful features such as Keeprole, Warn user, or even more in the future.
